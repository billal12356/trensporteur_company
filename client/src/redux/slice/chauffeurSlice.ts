...
export const fetchChauffeurs = createAsyncThunk(
    ...
    async (params: { search: string, limit?: number; page?: number; sort?: string }, { rejectWithValue }) => {
        ...
        try {
            const response = await axios.get("https://trensporteur-company.onrender.com/api/v1/chauffeurs/find-all", {
                params,
...
>(
    ...
    async (data, { rejectWithValue }) => {
        try {
            const response = await axios.post<Chauffeur>('https://trensporteur-company.onrender.com/api/v1/chauffeurs/create', data, { withCredentials: true });
