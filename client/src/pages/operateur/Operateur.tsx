...
const EnhancedOperateur = React.memo((): ReactElement => {
  ...
  const columnDefinitions: Array<[keyof any, string]> = [
    ...
    ["num_registre_commerce_n5", "رقم السجل التجاري 5"],
    ...
    ["depend_activite", "متوقف على النشاط أو لا"],
    ["type_depend", "نوع التوقيف (مؤقت أو نهائي)"],
  ...
  const columns = filteredColumnDefinitions.map(([key, label]) => {
    ...
    if (keyStr.toLowerCase().includes("date") || keyStr.toLowerCase().includes("hestoire") || keyStr === "createdAt" || keyStr === "updatedAt") {
              ...
              <CardContent className="p-6">
                <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Button onClick={handleExport} disabled={isExporting || operateurs.length === 0} className="gap-2 bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700">
